...
crime_data <- read.csv("~/Desktop/Crime_Incidents_in_2024.csv", header = TRUE)
head(crime_data)
```
...
library(corrplot)
corrplot(chi_result$residuals, is.corr = FALSE, tl.col = "black", col = colorRampPalette(c("blue", "white", "darkgreen"))(200))
```
